      ...
      <div style={{width:'100%', maxWidth:'500px'}}>
        ...
        {step === 0 && (
          <div style={{textAlign:'center'}}>
            <img src='/dune-pointe.png' style={{width:'110px',height:'110px',objectFit:'contain',animation:'bounce 2s infinite',filter:'drop-shadow(0 4px 16px rgba(124,92,252,0.5))',mixBlendMode:'screen' as any,marginBottom:'12px'}} alt='Dune'/>
        ...
        {step === 1 && (
          <div>
            <img src='/dune-pointe.png' style={{width:'90px',height:'90px',objectFit:'contain',animation:'bounce 2s infinite',filter:'drop-shadow(0 4px 16px rgba(124,92,252,0.5))',mixBlendMode:'screen' as any,marginBottom:'12px'}} alt='Dune'/>
        ...
        {step === 2 && (
          <div>
            <img src='/dune-lit.png' style={{width:'90px',height:'90px',objectFit:'contain',animation:'bounce 2s infinite',filter:'drop-shadow(0 4px 16px rgba(124,92,252,0.5))',mixBlendMode:'screen' as any,marginBottom:'12px'}} alt='Dune'/>
        ...
        {step === 3 && (
          <div>
            <img src='/dune-celebre.png' style={{width:'90px',height:'90px',objectFit:'contain',animation:'bounce 2s infinite',filter:'drop-shadow(0 4px 16px rgba(124,92,252,0.5))',mixBlendMode:'screen' as any,marginBottom:'12px'}} alt='Dune'/>
        ...
        {step === 4 && (
          <div style={{textAlign:'center'}}>
            <img src='/dune-celebre.png' style={{width:'130px',height:'130px',objectFit:'contain',animation:'bounce 1s infinite',filter:'drop-shadow(0 4px 20px rgba(124,92,252,0.7))',mixBlendMode:'screen' as any,marginBottom:'12px'}} alt='Dune'/>
