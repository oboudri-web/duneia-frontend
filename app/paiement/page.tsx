          ...
          <div style={{display:'flex', flexDirection:'column', gap:'10px', marginBottom:'20px'}}>
            <div style={{position:'relative'}}>
              <div onClick={()=>setSelectedPlan('annuel')} style={{
                ...
                <div style={{fontFamily:'Fredoka,sans-serif', fontSize:'1rem', fontWeight:700, color:'#ffd166'}}>Premium Annuel</div>
                <div style={{fontFamily:'Fredoka,sans-serif', fontSize:'1.4rem', fontWeight:700, marginTop:'4px', color:'#ffd166'}}>
                  79€<span style={{fontSize:'0.75rem', fontWeight:700, color:'#8e8cb0'}}>/an</span>
                </div>
